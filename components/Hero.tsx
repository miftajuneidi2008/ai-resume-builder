        ...
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="text-center md:w-1/2 md:text-left lg:w-2/5">
            ...
            <div className="flex flex-col justify-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 md:justify-start">
              <a
                href="#get-started"
                className="transform rounded-lg bg-blue-600 px-6 py-3 font-bold text-white shadow-lg transition-transform hover:scale-105 hover:bg-blue-700"
              >
          ...
          <div className="mt-10 flex justify-center md:mt-0 md:w-1/2 lg:w-3/5">
            <div className="relative w-full max-w-lg">
              ...
              <Image
                ...
                width={600}
                height={400}
                className="h-[400px] w-full transform rounded-lg shadow-2xl transition-transform duration-500 ease-in-out hover:scale-105 sm:h-[300px] lg:h-[400px]"
              />
